...
import io.rdbc.japi.{ParametrizedSelect, ResultSet, ResultStream, Row}
...
private[javawrappers] class ParametrizedSelectWrapper(underlying: sapi.ParametrizedSelect)
                                                     (implicit ec: ExecutionContext) extends ParametrizedSelect {
